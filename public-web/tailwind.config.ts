    ...
    extend: {
      colors: {
        ...
        node: {
          ...
          published: "hsl(var(--node-published))",
          section: "hsl(var(--node-section))",
          evidence: "hsl(var(--node-evidence))",
      ...
      animation: {
        ...
        "pulse-once": "pulse-once 200ms ease-out",
        "count-up": "count-up 150ms ease-out",
        reveal: "reveal 300ms ease-out forwards",
        "draw-edge": "draw-edge 500ms ease-out forwards",
